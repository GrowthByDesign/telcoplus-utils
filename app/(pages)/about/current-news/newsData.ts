...
export const newsData = [
  ...
  },
  {
    ...
    description:
      "Please inform us if you will be traveling. This will ensure that your debit card works! You can send a secure message in Home Banking or the App to Member Services. You can also call us during operating hours.",
  },
];
